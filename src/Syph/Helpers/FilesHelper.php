...
class FilesHelper {
	...
	public static function normalizePath($path, $ds = DIRECTORY_SEPARATOR) {
		$path = self::translateSystemInfo($path);
	...
	*/
	...
	/**
	 * Translate system informations
	 * 
	 * @param string $path
	 */
	public static function translateSystemInfo($path){
		return str_replace('@appPath', APP_REAL_PATH, $path);
	}
}